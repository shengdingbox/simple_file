package com.zhouzifei.mediaTool.modules.user.service.impl;
...
import com.zhouzifei.mediaTool.modules.share.vo.ShareUserInfoVO;
import com.zhouzifei.mediaTool.modules.user.constant.UserConstant;
import com.zhouzifei.mediaTool.modules.user.dao.RPanUserMapper;
import com.zhouzifei.mediaTool.modules.user.entity.RPanUser;
import com.zhouzifei.mediaTool.modules.user.service.IUserService;
import com.zhouzifei.mediaTool.modules.user.vo.RPanUserVO;
...
import com.zhouzifei.mediaTool.util.PasswordUtil;
import com.zhouzifei.mediaTool.util.UUIDUtil;
...
public class UserServiceImpl implements IUserService {
    ...
    public void exit(Long userId) {
        try {
            redisUtil.del(CommonConstant.USER_LOGIN_PREFIX + userId);
        } catch (Exception e) {
            e.printStackTrace();
