package com.zhouzifei.simplefile.modules.file.entity;
...
public class RPanFile implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(fileId, rPanFile.fileId) &&
                ...
                Objects.equals(md5, rPanFile.md5) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fileId, filename, realPath, fileSize, fileSizeDesc, fileSuffix, filePreviewContentType, md5, createUser, createTime);
    }
