package com.zhouzifei.simplefile.util.file.type.context;

import com.zhouzifei.simplefile.util.ReflectUtil;
import com.zhouzifei.simplefile.util.file.type.FileTypeDefiner;
...
public class FileTypeContext {
    ...
    static {
        Set<Class> allSubTypeOfFileTypeDefiner = ReflectUtil.getAllSubTypeOf(FileTypeDefiner.class, "com.zhouzifei.mediaTool.util.file.type");
