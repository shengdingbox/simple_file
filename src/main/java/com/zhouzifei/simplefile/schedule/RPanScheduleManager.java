package com.zhouzifei.simplefile.schedule;

import com.zhouzifei.cache.CacheEngine;
...
public class RPanScheduleManager {
    ...
    private CacheEngine cache = new FileCacheEngine();
    ...
    public String startTask(RPanScheduleTask rPanScheduleTask, String cron) {
        ...
        cache.add(key, rPanScheduleTaskHolder);
